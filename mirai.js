...
const config = {
  ...
  async function connectUptime(url, name) {
    try {
      const res = (await axios.get(`https://uptime.abcdz1238.repl.co?add=${url}`)).data;
