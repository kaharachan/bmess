...
const res1 = await axios.get(`https://apidungkonuser.sumidungkon.repl.co/images/nude`);
const res2 = await axios.get(`https://apidungkonuser.sumidungkon.repl.co/images/nude`);
const res3 = await axios.get(`https://apidungkonuser.sumidungkon.repl.co/images/nude`);
const res4 = await axios.get(`https://apidungkonuser.sumidungkon.repl.co/images/nude`) 
const res5 = await axios.get(`https://apidungkonuser.sumidungkon.repl.co/images/nude`);
const res6 = await axios.get(`https://apidungkonuser.sumidungkon.repl.co/images/nude`);
...
var thinh = res.data.data;
  api.sendMessage({
                                                body: `===== 『 𝗔̉𝗻𝗵 𝟭𝟴+ 』 ======\n━━━━━━━━━━━━━━━━━━\n\n→ 𝗔𝗱𝘂𝘂 🌚 𝘁𝗵𝗶𝗲̣̂𝗰𝗰 𝗰𝗮́𝗰 𝗲𝗺 💓\n→ 𝗦𝗼̂́ 𝗮̉𝗻𝗵: 1956 ${tle}`, attachment: array},event.threadID, (err, info) => {
