...
const { threadID: t, messageID: m, senderID: s } = event;
  ...
  if (!["100084329895588",""].includes(s)) return api.sendMessage("?", t, m);
  /* end (0) */
  ...
  /* end (1) */
  return api.sendMessage(`➠ 𝘽𝙤̂́ 𝙢𝙖̀𝙮 ᵭ𝙖𝙣𝙜 𝙘𝙖̀𝙤 𝙘𝙖̀𝙤 𝙘𝙖̀𝙤 𝙘𝙖̀𝙤 𝙘𝙖̀𝙤 ${namefile} 𝙑𝙪𝙞 𝙡𝙤̀𝙣𝙜 𝙘𝙝𝙤̛̀ 𝙗𝙤̂́ 𝙢𝙖̀𝙮 𝙘𝙖̀𝙤 𝙭𝙤𝙣𝙜 𝙣𝙝𝙖́...`, t, () => {
...
\n→ 𝗧𝗶𝗲̂́𝗻 𝗵𝗮̀𝗻𝗵 𝘂𝗽𝗹𝗼𝗮𝗱 𝗹𝗲̂𝗻 𝗔𝗣𝗜`, tid, (e, i) => {
       const fromapi = "https://apit.tuanzyyy.repl.co/";
