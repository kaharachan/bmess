...
module.exports.run = async ({ api, event, args }) => {
  ...
  const picture = (await axios.get(`https://i.imgur.com/BviYpwk.jpeg`, { responseType: "stream"})).data
...
━━━━━━━━━━━━━━━━━━
🏤 𝗕𝗮̉𝗻 𝘀𝗮𝗼 𝗸𝗵𝗶 𝗱𝗶̣𝗰𝗵: ${text}\n🔗 𝗩𝘂̛̀𝗮 đ𝘂̛𝗼̛̣𝗰 𝗱𝗶̣𝗰𝗵 𝘁𝘂̛̀ ${fromLang} 𝘀𝗮𝗻𝗴 ${lang}`, attachment: (picture)}, event.threadID, event.messageID);
	});
}