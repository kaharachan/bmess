...
module.exports.handleReply = async function({ api, args, event, handleReply, Users }) {
  try {
    ...
    switch (handleReply.type) {
      ...
      case "calladmin": {
        if (s.length == 0) {
          api.sendMessage({ body: `[📌] 𝗣𝗵𝗮̉𝗻 𝗵𝗼̂̀𝗶 𝘁𝘂̛̀ 𝐜𝐮𝐧𝐠 𝐜𝐡𝐮̉ ${name} 𝘁𝗼̛́𝗶 𝗯𝗮̣𝗻:\n\n[💬] 𝗡𝗼̣̂𝗶 𝗱𝘂𝗻𝗴: ${(event.body) || "𝗸𝗵𝗼̂𝗻𝗴 𝗰𝗼́ 𝗻𝗼̣̂𝗶 𝗱𝘂𝗻𝗴 𝘁𝗿𝗮̉ 𝗹𝗼̛̀𝗶 🌸"}\n\n» 𝗣𝗵𝗮̉𝗻 𝗵𝗼̂̀𝗶 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝗻𝗲̂́𝘂 𝗺𝘂𝗼̂́𝗻 𝘁𝗶𝗲̂́𝗽 𝘁𝘂̣𝗰 𝗴𝘂̛̉𝗶 𝗯𝗮́𝗼 𝗰𝗮́𝗼 𝘃𝗲̂̀ 𝐜𝐮𝐧𝐠 𝐜𝐡𝐮̉`, mentions: [{ tag: name, id: event.senderID }] }, handleReply.id, (e, data) => global.client.handleReply.push({
            name: this.config.name,
            author: event.senderID,
            messageID: data.messageID,
            type: "reply"
          ...
          api.sendMessage({ body: `[📌] 𝗣𝗵𝗮̉𝗻 𝗵𝗼̂̀𝗶 𝘁𝘂̛̀ 𝐜𝐮𝐧𝐠 𝐜𝐡𝐮̉ ${name} 𝘁𝗼̛́𝗶 𝗯𝗮̣𝗻:\n\n[💬] 𝗡𝗼̣̂𝗶 𝗱𝘂𝗻𝗴: ${(event.body) || "𝗰𝗵𝗶̉ 𝗰𝗼́ 𝘁𝗲̣̂𝗽 𝗸𝗵𝗼̂𝗻𝗴 𝗰𝗼́ 𝗻𝗼̣̂𝗶 𝗱𝘂𝗻𝗴 𝘁𝗿𝗮̉ 𝗹𝗼̛̀𝗶 🌸"}\n[💌] 𝗧𝗲̣̂𝗽 𝐜𝐮𝐧𝐠 𝐜𝐡𝐮̉ 𝗴𝘂̛̉𝗶 𝘁𝗼̛́𝗶 𝗯𝗮̣𝗻\n\n» 𝗣𝗵𝗮̉𝗻 𝗵𝗼̂̀𝗶 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝗻𝗲̂́𝘂 𝗺𝘂𝗼̂́𝗻 𝘁𝗶𝗲̂́𝗽 𝘁𝘂̣𝗰 𝗴𝘂̛̉𝗶 𝗯𝗮́𝗼 𝗰𝗮́𝗼 𝘃𝗲̂̀ 𝐜𝐮𝐧𝐠 𝐜𝐡𝐮̉`, attachment: l, mentions: [{ tag: name, id: event.senderID }] }, handleReply.id, (e, data) => global.client.handleReply.push({
            name: this.config.name,
            author: event.senderID,
            messageID: data.messageID,
            type: "reply"
...
module.exports.run = async function({ api, event, Threads, args, Users }) {
  try {
    ...
    api.sendMessage(`[👾] - 𝗠𝗲𝗴𝘂𝗿𝗶 𝘃𝘂̛̀𝗮 𝗴𝘂̛̉𝗶 𝘁𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻 𝘁𝗼̛́𝗶 ${soad} 𝐜𝐮𝐧𝐠 𝐜𝐡𝐮̉ 🍄\n 𝐂𝐡𝐮̉ 𝐛𝐨𝐭: fb.me/toanchill2005\n[⏰] ${gio}`,
      event.threadID,
      () => {
        var idad = global.config.ADMINBOT;
        if (s.length == 0) {
          for (let ad of idad) {
            api.sendMessage({ body: `📱====[ 𝐂𝐀𝐋𝐋 𝐂𝐮𝐧𝐠 𝐂𝐡𝐮̉ ]====📱\n\n[👤] 𝗕𝗮́𝗼 𝗰𝗮́𝗼 𝘁𝘂̛̀: ${name}\n[❗] 𝗜𝗗 𝗨𝘀𝗲𝗿 ${uid}\n[👨‍👩‍👧‍👧] 𝗕𝗢𝗫: ${namethread}\n[🔰] 𝗜𝗗 𝗕𝗢𝗫: ${idbox}\n\n[💌] 𝗜𝗻𝗯𝗼𝘅: ${args.join(
              " "
