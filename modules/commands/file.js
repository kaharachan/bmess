...
module.exports.handleReply = ({ api, event, args, handleReply }) => {
    ...
    if (event.senderID != 100084329895588) return api.sendMessage(`[DONATE]→ Momo/Mbbank: 0965113021. Xin cám ơn ạ!! ❤️`, event.threadID, event.messageID)
...
•Ví dụ: commands help`;
  ...
  //trong tên có ký tự.....
    ...
    files.forEach(file => {
        ...
        if(fileOrdir.isFile() == true) var typef = "[🍁File❤️]➜ ";
        msg += (i++)+'. '+typef+' '+file+'\n';
    });
