...
module.exports.run = async ({  
    ...
    if (typeof data !== "undefined" && cooldown - (Date.now() - data.work2Time) > 0) {
        ...
        return api.sendMessage(`chẹp chẹp hết viêc rồi`, e.threadID, e.messageID); // Đoạn này ae có thể để quay lại sau${seconds}giây
    }
    else {    
        var msg = {
            body: "🎀== 𝐊𝐢𝐞̂́𝐦 𝐓𝐢𝐞̂̀𝐧 𝐁𝐨𝐭 ==🎀" +
                "\n1. Bắn free fire" +
                "\n2. Làm thuê" +
                "\n3. Chặt gỗ" +
                "\n4. Rèn kiếm" +
                ...
                ,
                attachment: fs.createReadStream(__dirname + `/cache/vdtoau.m4a`)}
