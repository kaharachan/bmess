...
💓 𝗖𝗮́𝗰 𝗯𝗮̣𝗻 𝗸𝗵𝗮́𝗰 𝗰𝗼̂́ 𝗴𝗮̆́𝗻 𝘁𝘂̛𝗼̛𝗻𝗴 𝘁𝗮́𝗰 𝗻𝗲̂́𝘂 𝗺𝘂𝗼̂́𝗻 𝗹𝗲̂𝗻 𝘁𝗼𝗽 𝗻𝗵𝗮\n⏰===「 ${time} 」===⏰`;
        ...
        api.sendMessage({body:checkttBody,attachment: fs.createReadStream(__dirname + `/../modules/commands/noprefix/ttAdmin.mp4`)}, checkttFile.replace('.json', ''), (err) => err ? console.log(err) : '');
